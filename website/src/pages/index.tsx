      ...
      <div className={styles.heroInner}>
        <div className={styles.heroCopy}>
          ...
          <p className={styles.subtitle}>
            A mobile-native AI runtime for Expo &amp; React Native. It detects what each device can
            run, routes to the best provider, and tells you the privacy implications of every
            response.
          </p>
    ...
    <section className={styles.section}>
      <div className={styles.sectionHead}>
        ...
        <p className={styles.sectionLede}>
          The same call works across Apple Foundation Models, Android Gemini Nano and your cloud
          backend. Capability detection and fallback are handled for you.
        </p>
      </div>
